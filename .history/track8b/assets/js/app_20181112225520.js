...
(function(self) {
  ...
  // some config vars - for slow-motion lower the speed/damping, set clearScreenBetweenDraws to false if you want to 'draw', for powerful comps you can increase the canvas size cw/ch, set pw/ph to 200 or more, load in a larger image etc
    cw = 600, ch = 400, pw = 200, ph = 200, damping=0.96,easeBackSteps=23,speed=77, clearScreenBetweenDraws=true, // default to false on IE10 
     //   imgsrc = 'https://i.imgur.com/LMNxXAJ.jpg',
    
              imgsrc = 'https://res.cloudinary.com/dbie43oob/image/upload/v1473334894/LMNxXAJ_lgjofn.jpg',
